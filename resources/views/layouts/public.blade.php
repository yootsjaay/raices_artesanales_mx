...
<body class="font-sans antialiased text-oaxaca-text-dark-gray bg-oaxaca-bg-cream">

    <header class="bg-oaxaca-navbar-blue text-oaxaca-text-white p-4 shadow-lg">
        <nav class="container mx-auto flex justify-between items-center">
            <a href="{{ url('/') }}" class="text-3xl font-extrabold tracking-wide hover:text-oaxaca-navbar-orange transition-colors">
            ...
            <ul class="flex space-x-6 text-lg">
                ...
                {{-- ELIMINADO: <li><a href="{{ route('artesanos.index') }}" class="hover:text-oaxaca-navbar-orange transition-colors">Artesanos</a></li> --}}
    ...
    <footer class="bg-oaxaca-navbar-blue text-oaxaca-text-white py-8 mt-12">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <div class="mt-4">
                <a href="#" class="text-oaxaca-navbar-orange hover:text-oaxaca-text-white mx-2 transition-colors">Facebook</a>
