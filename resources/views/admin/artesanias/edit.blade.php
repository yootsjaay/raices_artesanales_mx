        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.artesanias.update', $artesania->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT') {{-- Usa PUT o PATCH para las actualizaciones RESTful --}}
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="dimensiones" id="dimensiones" value="{{ old('dimensiones', $artesania->dimensiones) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="tecnica_empleada" id="tecnica_empleada" value="{{ old('tecnica_empleada', $artesania->tecnica_empleada) }}"
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="descripcion" id="descripcion" rows="4"
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm @error('descripcion') border-red-500 @enderror">{{ old('descripcion', $artesania->descripcion) }}</textarea>
                            @error('descripcion')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="historia_pieza" id="historia_pieza" rows="4"
                                      class="mt-1 block w-full border-gray-300 rounded-md shadow-sm @error('historia_pieza') border-red-500 @enderror">{{ old('historia_pieza', $artesania->historia_pieza) }}</textarea>
                        ...
                        <div class="mt-6">
                            ...
                            @if ($artesania->imagen_principal)
                                ...
                                <img src="{{ asset('storage/' . $artesania->imagen_principal) }}" alt="Imagen principal actual" class="mt-2 w-32 h-32 object-cover rounded-md shadow-md">
                            @endif
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            @if ($artesania->imagen_adicionales)
                                <p class="mt-2 text-sm text-gray-600">Imágenes adicionales actuales:</p>
                                <div class="flex flex-wrap gap-2 mt-2">
                                    @foreach (json_decode($artesania->imagen_adicionales, true) as $img_path)
                                        <img src="{{ asset('storage/' . $img_path) }}" alt="Imagen adicional" class="w-24 h-24 object-cover rounded-md shadow-md">
                                    @endforeach
                                </div>
                            @endif
                        </div>
